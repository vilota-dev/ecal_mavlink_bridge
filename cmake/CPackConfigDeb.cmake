...
if(LSB_RELEASE_PROGRAM)
  ...
  if(${LSB_RELEASE_ID_SHORT} EQUAL "20.04")
    set(DEBIAN_DEPENDS "libprotobuf-dev, ecal (>= ${eCAL_VERSION})")
  endif()
...
# set(CPACK_PACKAGING_INSTALL_PREFIX "/opt/vilota")
...
set(CPACK_DEBIAN_PACKAGE_MAINTAINER "Huimin Cheng <huimin@vilota.ai>")
